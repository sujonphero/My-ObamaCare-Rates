  ...
  return (
    <div className='bg-gray-100 py-10'>
        <div className='md:mx-[280px] px-4'>
            ...
            <p className='text-xl'>
            Leads Team, LLC grants you a personal, non-transferable and non-exclusive right and license to use the Site on a computer or other Internet device; provided that you do not (and do not allow any third party to) copy, reproduce, distribute, reverse engineer or otherwise exploit any content, code, data or materials on the Site. You agree not to modify the Site in any manner or form, nor to use modified versions of the Site for any purpose. We do not grant any license or other authorization to any user to use our trade names, trademarks, service marks or other marks or logos or those of our partners without our separate express written agreement. Third party marks are the property of their respective owners.
            </p><br />
